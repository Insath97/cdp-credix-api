    ...
    public function up(): void
    {
        ...
        DB::table('settings')->insert([
            ...
            [
                ...
                'type' => 'integer',
                'group' => 'credit_score',
                'description' => 'Points awarded for each installment settled on or before its due date (plus the credit score grace days).',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'type' => 'integer',
                'group' => 'credit_score',
                'description' => 'Points deducted for each installment settled late, or still unpaid past its grace period. Enter a positive number; it is subtracted.',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
            ...
            [
                'key' => 'credit_score_normalize_max',
                'value' => '100',
                'type' => 'integer',
                'group' => 'credit_score',
                'description' => 'Top of the displayed score scale. The per-installment average is mapped onto 0..this value, so a borrower who paid every month on time scores this and one who was late every month scores 0. Set it to 0 to store the raw average instead (which can be negative).',
                'created_at' => now(),
                'updated_at' => now(),
            ],
        ]);
